...
cm_2_class_015 = metrics.calc_confusion_matrix( true_labels=true_labels_2_class, p_values=p_vals_2_class, significance=0.15 )
cm_2_class_075 = metrics.calc_confusion_matrix( true_labels=true_labels_2_class, p_values=p_vals_2_class, significance=0.75 )
...
cm_3_class_015 = metrics.calc_confusion_matrix( true_labels=true_labels_3_class, p_values=p_vals_3_class, significance=0.15 )
